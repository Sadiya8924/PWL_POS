...
Route::group(['prefix' => 'user'], function(){
    ...
    Route::post('/ajax', [UserController::class, 'store_ajax']); //menyimpan data user abru Ajax
    Route::get('/{id}', [UserController::class, 'show']); // menampilkan detail user
    Route::get('/{id}/edit', [UserController::class, 'edit']); // menampilkan halaman form edit user
    Route::put('/{id}', [UserController::class, 'update']); // menyimpan data user yang diubah
    Route::get('/{id}/edit_ajax', [UserController::class, 'edit_ajax']); //menampilkan halaan form edit user ajax
